...
<div class="container-full">
	 ...
	 <div class="form-group">
		...
		<div class="controls">
	 <input type="file" name="logo" class="form-control" onChange="mainThamUrl(this)" > </div>
	 <img src="" id="mainThmb">
	</div>
...
<div class="form-group">
	...
	<div class="form-group">
		<h5>Instargram <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="text" name="instragram" class="form-control"  value="{{ $setting->instragram }}"  > </div>
	</div>
