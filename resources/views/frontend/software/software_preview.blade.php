        ...
        <div class="row mt-5">
            <div class="col-lg-8">
                ...
                <div class="btn-grp mt40 mb-3">
                    <a href="{{ $previews->demo }}" class="btn-main bg-btn lnk"> Live Demo <i class="fas fa-share"></i>
                        ...
                        <div class="tab-content" id="myTabContent2">
                                    ...
                                    <div class="form-block form-blog mt40">
                                        <form action="{{ route('comment-store') }}" method="post" name="#">
                                            ...
                                            <div class="fieldsets mt10">
                                                <button type="submit" name="#" class="btn-main bg-btn3 lnk">Post Comment
                                ...
                                <div class="rpb-commentss comments-block">
                                    ...
                                    <div class="media replied">
                                        {{-- <div class="user-image"><img
                                                src="frontend/assets/images/user-thumb/user3.jpg" alt="girl"
                                                class="img-fluid" /></div> --}}
                            ...
                            <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4c">
                                <div class="rpb-itm-support-txt">
                                    <h4>Contact Us</h4>
                                    <p>Lorem Ipsum is simply dummy text of the printing and through email contact form.
                                    </p>
                                    ...
                                    <div class="btns">
                                        <a href="{{ route('contact-us') }}" class=" mt30 btn-main bg-btn3 lnk">Get
                                            Support <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="rpb-item-infodv">
                    <ul>
                        ...
                        <li>
                            <strong>Yearly Charge</strong>
                            <div class="nx-rt">{{$previews->yearly_charge}}</div>
                        </li>
                        <li>
...
@else
<div>
    <span>After purches Product then add review</span>
</div>
