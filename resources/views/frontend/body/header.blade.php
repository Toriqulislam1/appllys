        ...
        <div class="menu-header">
            ...
            <div class="custom-nav" role="navigation">
                <ul class="nav-list onepge">
                    ...
                    <li><a href="{{ route('ready.software') }}" target="_blank" class="menu-links">Ready Software</a>
                    </li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="sub-menu-center-block">
                                            ...
                                            <div class="sub-menu-column">
                                                ...
                                                <a
                                                    href="{{ url('/services/subcategory/'.$subcategory->id.'/'.$subcategory->subcategory_slug) }}">
                                                ...
                                                @php
                                                $childcategories =
                                                App\Models\Childcategory::where('subcategory_id',$subcategory->id)->orderBy('childcategory_name','DESC')->get();
                                                @endphp
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a
                                                            href="{{ url('/childcategory/services/'.$childcategory->id.'/'.$childcategory->childcategory_slug) }}">{{
                                                            $childcategory->childcategory_name}}</a></li>
                    ...
                    {{-- <li><a href="get-quote.html" class="btn-br bg-btn5 btshad-b2 lnk" data-bs-toggle="modal"
                            data-bs-target="#menu-popup">Request A Project <span class="circle"></span></a> </li> --}}




                            @if (Auth::guard('customer')->check())
                            <li><a href="{{route('deshboard-check')}}" class="menu-links">Deshboard</a></li>
                                @else
                    ...
                    <div class="form-block fdgn2 mt10 mb10">
                        <form action="{{ route('contact-form')}}" method="post" name="feedback-form">
                            ...
                            <div class="fieldsets row">
                                <div class="col-md-12"><input type="text" placeholder="Full Name" name="full_name">
                                </div>
                                <div class="col-md-12"><input type="email" placeholder="Email Address"
                                        name="email_address"></div>
                                <div class="col-md-12"><input type="number" placeholder="Contact Number" name="mobile">
                                </div>
