...
Route::get('/service/{category_slug}', [IndexController::class, 'CatWiseService']);
...
Route::prefix('setting')->group(function(){
    ...
    Route::get('/add', [SettingController::class, 'Setting'])->name('setting-add');

    Route::post('/update', [SettingController::class, 'UpdateSetting'])->name('setting-update');

    Route::get('/fav', [SettingController::class, 'Favicon'])->name('setting-fav');
